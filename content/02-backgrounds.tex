...
\paragraph{\gls{negmas} and Negotiator} Negotiator is an entity in a negotiation mechanism. Several negotiators are natively implemented in \gls{negmas}. AspirationNegotiator, SimpleTitForTatNegotiator and PassThroughSAONegotiator are negotiators, which were developed for \gls{saom}.
...
\paragraph{Agent in \gls{scml-oneshot}} Agent GreedyOneShotAgent and SingleAgreementAspirationAgent were developed as the native part of \gls{scml-oneshot}.
