...
\paragraph{Heuristic agents(e.g., AspirationNegotiator)}
...
The following paragraphs will evaulate the results based on the two questions and method raised in section \ref{methods:maddpg}. 
